/**
 * Brand marks that lucide-react v1 no longer ships (it dropped brand icons).
 *
 * Kept minimal and `currentColor`-driven so they inherit the same styling as
 * the lucide icons beside them. Used only to label links to those services.
 */
